...
def force_align(SPEECH_FILE, transcript, start_index, start_time):
    ...
    for i,word in enumerate(word_segments):
        ...
        subs.append({"word":word.label, "start":str(start.total_seconds()), "end":str(end.total_seconds())})
...
if __name__ == "__main__":
    ...
    ffmpeg_command = "ffmpeg -i " + mp4_file + " -ab 160k -ac 2 -ar 44100 -vn " + tmp_filename + ".wav -y 2> /dev/null "
